...
Table 1 shows baseline demographic characteristics of the cancer and non-cancer groups by age, gender, race/ethnicity, education level, marital status, household size, and income to poverty ratio. The distribution of variables in each group does not appear balanced, as the cancer group appears to have older mean age (54.9 +/- 11.7) a higher proportion of women (60.6%), higher education level (68.8% with at least some college), a higher percentage of married individuals (64.1%), and smaller household size (56.5% with 2 or fewer household members).

The first figure below shows a summary of counts in the non-cancer (2459 individuals) vs cancer groups (170 individuals). 
The second figure is a violin plot showing age distribution by cancer status. The 3rd figure similarly shows a density plot of age distribution by cancer status. As seen in these plots, the cancer group is distributed such that individuals appear to be distrubed at older ages than the non-cancer group with a more even distribution across younger and older ages. 

The 4th figure shows a summary of gender distribution by cancer status. The cancer group features a higher proportion of women, while the non-cancer group features a relatively more even distribution between men and women. 

The 5th figure shows a boxplot of age by gender and cancer status. The non-cancer group shows a fairly similar distribution of age and gender. The men in the cancer group feature older mean age than the women in the cancer group with a younger age distribution.
